...
namespace AspNetCore.Data.Entities
{
    ...
    public class PostCategory : DomainEntity<Guid>, IMetaData, ISwitchable, ISortable, IDateTracking
    {
        public PostCategory()
        {
        ...
        public PostCategory(Guid id, Guid? parentId, int currentIdentity, string name, string pageAlias, string description, string image, bool? homeFlag, 
